 ...
 */
GE.EventUtil.add_event_handler = function(target, type, fn) {
 ...
 */
GE.EventUtil.remove_event_handler = function(target, type, fn) {
 ...
 * @return Event
 */
GE.EventUtil.create_event = function(type, detail) {
	var ev = new Object();
	ev.bubbles = false;
	ev.cancelable = false;
	ev.target = null;
