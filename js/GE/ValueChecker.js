 ...
 * @return string
 */
GE.ValueChecker.string = function(value, varname, empty_allowed, min, max, 
	disallowed_chars)
{
 ...
 * @return float
 */
GE.ValueChecker.float = function(value, varname, min, max) {
 ...
 * @return uint
 */
GE.ValueChecker.id = function(value, varname, zero_allowed) {
	if (zero_allowed)
		return GE.ValueChecker.int(value, varname, 0);
	else
		return GE.ValueChecker.int(value, varname, 1);
};
 ...
 * @return uint
 */
GE.ValueChecker.t_stamp = function(value, varname) {
	return GE.ValueChecker.int(value, varname, 0);
};
 ...
 * @return int
 */
GE.ValueChecker.int = function(value, varname, min, max) {
	if (typeof(min) == 'undefined') {
		if (typeof(max) == 'undefined') {
 ...
 * @return mixed
 */
GE.ValueChecker.values = function(value, varname, values) {
 ...
 * @return bool
 */
GE.ValueChecker.bool = function(value, varname) {
...
GE.ValueChecker.instance_of = function(value, varname, instance) {
	try {
	if (!GE.instance_of(value, instance)) {
		throw new Error(varname + " has to be an instance of "
